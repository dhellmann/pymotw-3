...
\newcommand{\notenoheader}[1]{\pagebreak[3]\par\vspace*{2ex} % define a note command without a header
\noindent{\sffamily\bfseries\small NOTE}\linebreak\vspace*{-1.5ex}\nopagebreak
\rule[1.5ex]{\textwidth}{.75pt}\linebreak\nopagebreak
{\sffamily\small
\noindent{#1}}\par
...
\newcommand{\warningnoheader}[1]{\pagebreak[3]\par\vspace*{2ex} % define a warning command without a header
\noindent{\sffamily\bfseries\small WARNING}\linebreak\vspace*{-1.5ex}\nopagebreak
\rule[1.5ex]{\textwidth}{.75pt}\linebreak\nopagebreak
{\sffamily\small
\noindent{#1}}\par

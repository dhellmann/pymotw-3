...
%%\lstset{basicstyle=\small\sffamily,xleftmargin=5ex,framerule=0.5pt} % setting the code in small font and
										 % setting	the margin for the code.  Nov 2015: setting the rules to be 0.5pt

%% (dhellmann) Use Bera Mono for monospaced font, based on instructions in

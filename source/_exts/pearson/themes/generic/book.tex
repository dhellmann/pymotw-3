...
{% if dedication_doc %}{{'\include{'}}{{dedication_doc}}{{'}'}}{% endif %}

%% Trying for a table of contents that only includes the chapter
%% titles, using shorttoc, but it causes duplicate entries for itself
%% and for the actual table of contents.
%%
%% \cleardoublepage
%% \shorttableofcontents{Contents At a Glance}{0}
...
{% for frontmatter in [foreword_doc, preface_doc, acknowledgements_doc, about_doc, intro_doc] -%}
{% if frontmatter %}
{{'\include{'}}{{frontmatter}}{{'}'}}
{% endif %}
{% endfor %}

...
available. Various APIs are provided to make it convenient to wait for
tasks to complete, so that the :class:`Future` objects do not need to
be managed directly.
...
::
	...
	ran task 5 in process 52429
	ran task 4 in process 52430
	ran task 3 in process 52429
	ran task 2 in process 52429
	ran task 1 in process 52430
